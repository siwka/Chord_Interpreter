...
class ChordParser
  ...
  def self.quality_of input
    ...
    when '', 'M', 'maj', 'major', 'major7', '6', 'M6', 'maj6', 'M7', 'Ma7', 'maj7'
      'maj'
    when 'm3', 'm', '-', 'min', 'minor', 'm6', 'm7', '-7', 'min7', 'minmaj7', 'min/maj7', 'min(maj7)', 'mM7', 'm/M7' ,'m(M7)', 'm#7', '-M7'
      'min'
    when 'aug', '+', '+5', 'M+5', 'M#5', 'aug7', '+7', 'augmaj7', 'aug/maj7', 'aug(maj7)', '+M7'
      'aug'
  ...
  def self.added_tone_of input
    ...
    when '7', 'dom7', 'M7', 'Ma7', 'maj7', 'major7', 'm7', '-7', 'min7', 'aug7', 'dim7', 'o7', '+7'
      '7'
    when 'minmaj7', 'min/maj7', 'min(maj7)', 'mM7', 'm/M7' ,'m(M7)', 'm#7', '-M7', 'augmaj7', 'aug/maj7', 'aug(maj7)', '+M7'
      'maj7'
